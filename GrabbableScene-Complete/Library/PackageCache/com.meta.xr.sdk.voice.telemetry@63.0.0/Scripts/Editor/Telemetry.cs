...
namespace Meta.Voice.TelemetryUtilities
{
    ...
    internal class Telemetry
    {
        ...
        /// </summary>
        private static readonly TelemetryChannel _liveChannel = new TelemetryChannel();
        ...
        private static void FirstRunInitialize()
        {
            EditorApplication.update -= FirstRunInitialize;
        ...
        private static void OnUnityEditorQuitting()
        {
